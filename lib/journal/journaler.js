...
class Journaler {
  ...
  /**
   * Returns the LineItem contained at the provided index from this Journaler instance.
   * @param {integer} index - Index of the line item to be retrived.
   *
   */
  Get(index) {
   ...
   */
   valid() {
    var val = true;
    if (!this.balance().equalsTo(Dinero({ amount: 0}))) {
      val = false;
    }
